...
import space.arim.dazzleconf.engine.liaison.CharacterLiaison;
import space.arim.dazzleconf.engine.liaison.CollectionLiaison;
import space.arim.dazzleconf.engine.liaison.DoubleLiaison;
import space.arim.dazzleconf.engine.liaison.EnumLiaison;
...
import space.arim.dazzleconf.engine.liaison.SubSectionLiaison;
...
public final class ConfigurationBuilder<C> {
     ...
     * {@link space.arim.dazzleconf.migration}, and you understand the "perpetual migration" trap.
     * <p>
