 ...
 * supported by the double liaison. Its presence will also <b>override</b> the value of the default method, if it exists.
 */
@Retention(RUNTIME)
@Target(METHOD)
public @interface DoubleDefault {
    ...
    /**
     * The double value to provide as an "if missing" default. See {@link DefaultValues#ifMissing()} for
     * considerations.
     *
     * @return the double value if missing
     */
    double ifMissing();
