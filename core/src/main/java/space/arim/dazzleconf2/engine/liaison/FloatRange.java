...
public @interface FloatRange {
     ...
     * The minimum value.
     * <p>
     * If set to {@code Float.NEGATIVE_INFINITY} (the default), the bounds check is disabled.
     *
     ...
     * The maximum value.
     * <p>
     * If set to {@code Float.POSITIVE_INFINITY} (the default), the bounds check is disabled.
     *
