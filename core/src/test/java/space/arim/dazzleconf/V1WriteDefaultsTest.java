...
public class V1WriteDefaultsTest {
	
	private ConfigurationFactory<V1DummyConfig> factory;
	
	@BeforeEach
	public void setup() {
		factory = new SerialisationFactory<>(V1DummyConfig.class, V1DummyConfigDefaults.createOptions());
	}
