...
class ComplexObjectSerialiser implements ValueSerialiser<ComplexObject> {
	...
	@Override
	public ComplexObject deserialise(FlexibleType flexibleType) throws BadValueException {
		...
		return new ComplexObject(count.getInteger(), name.getString(), enabled.getBoolean());
	}

	@Override
	public Object serialise(ComplexObject value, Decomposer decomposer) {
